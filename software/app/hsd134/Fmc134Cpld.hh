...
namespace Pds {
    namespace HSD {
        ...
        private:
            Pds::Mmhw::RegProxy _command; // device select
            Pds::Mmhw::RegProxy _control0; //
            Pds::Mmhw::RegProxy _control1; //
            uint32_t  _reserved3;
            Pds::Mmhw::RegProxy _status;
            Pds::Mmhw::RegProxy _version;
            Pds::Mmhw::RegProxy _i2c_data[4]; // write cache
            Pds::Mmhw::RegProxy _i2c_read[4]; // read cache
