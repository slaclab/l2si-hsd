...
# MGT Data Signals
# Bank 227
set_property PACKAGE_PIN AE1 [get_ports {adc_da_n[0][3]}]
set_property PACKAGE_PIN AE2 [get_ports {adc_da_p[0][3]}]
set_property PACKAGE_PIN AG1 [get_ports {adc_da_n[0][2]}]
set_property PACKAGE_PIN AG2 [get_ports {adc_da_p[0][2]}]
set_property PACKAGE_PIN AH3 [get_ports {adc_da_n[0][1]}]
set_property PACKAGE_PIN AH4 [get_ports {adc_da_p[0][1]}]
set_property PACKAGE_PIN AJ1 [get_ports {adc_da_n[0][0]}]
set_property PACKAGE_PIN AJ2 [get_ports {adc_da_p[0][0]}]
# Bank 230
set_property PACKAGE_PIN P3  [get_ports {adc_da_n[1][3]}]
set_property PACKAGE_PIN P4  [get_ports {adc_da_p[1][3]}]
set_property PACKAGE_PIN R1  [get_ports {adc_da_n[1][2]}]
set_property PACKAGE_PIN R2  [get_ports {adc_da_p[1][2]}]
set_property PACKAGE_PIN U1  [get_ports {adc_da_n[1][1]}]
set_property PACKAGE_PIN U2  [get_ports {adc_da_p[1][1]}]
set_property PACKAGE_PIN W1  [get_ports {adc_da_n[1][0]}]
set_property PACKAGE_PIN W2  [get_ports {adc_da_p[1][0]}]
# Bank 228
set_property PACKAGE_PIN Y3  [get_ports {adc_db_n[0][3]}]
set_property PACKAGE_PIN Y4  [get_ports {adc_db_p[0][3]}]
set_property PACKAGE_PIN AA1 [get_ports {adc_db_n[0][2]}]
set_property PACKAGE_PIN AA2 [get_ports {adc_db_p[0][2]}]
set_property PACKAGE_PIN AB3 [get_ports {adc_db_n[0][1]}]
set_property PACKAGE_PIN AB4 [get_ports {adc_db_p[0][1]}]
set_property PACKAGE_PIN AC1 [get_ports {adc_db_n[0][0]}]
set_property PACKAGE_PIN AC2 [get_ports {adc_db_p[0][0]}]
# Bank 231
set_property PACKAGE_PIN J1  [get_ports {adc_db_n[1][3]}]
set_property PACKAGE_PIN J2  [get_ports {adc_db_p[1][3]}]
set_property PACKAGE_PIN K3  [get_ports {adc_db_n[1][2]}]
set_property PACKAGE_PIN K4  [get_ports {adc_db_p[1][2]}]
set_property PACKAGE_PIN L1  [get_ports {adc_db_n[1][1]}]
set_property PACKAGE_PIN L2  [get_ports {adc_db_p[1][1]}]
set_property PACKAGE_PIN N1  [get_ports {adc_db_n[1][0]}]
set_property PACKAGE_PIN N2  [get_ports {adc_db_p[1][0]}]

# MGT RefClk Signals
#set_property PACKAGE_PIN AK7 [get_ports {adc_refclka_n[0]}]
#set_property PACKAGE_PIN AK8 [get_ports {adc_refclka_p[0]}]
#set_property PACKAGE_PIN AF7 [get_ports {adc_refclkb_n[0]}]
#set_property PACKAGE_PIN AF8 [get_ports {adc_refclkb_p[0]}]
#set_property PACKAGE_PIN V7  [get_ports {adc_refclka_n[1]}]
#set_property PACKAGE_PIN V8  [get_ports {adc_refclka_p[1]}]
#set_property PACKAGE_PIN P7  [get_ports {adc_refclkb_n[1]}]
#set_property PACKAGE_PIN P8  [get_ports {adc_refclkb_p[1]}]
# (original)
...
create_clock -period 3.360 -name adc_refclka_0 [get_ports {adc_refclka_p[0]}]
create_clock -period 3.360 -name adc_refclkb_0 [get_ports {adc_refclkb_p[0]}]
create_clock -period 3.360 -name adc_refclka_1 [get_ports {adc_refclka_p[1]}]
create_clock -period 3.360 -name adc_refclkb_1 [get_ports {adc_refclkb_p[1]}]
